export const roundABI = [
  ...
  },
  {
    ...
    inputs: [
      ...
      { indexed: true, internalType: 'uint256', name: 'status', type: 'uint256' },
    ],
  ...
  },
  {
    anonymous: false,
    inputs: [
      { indexed: false, internalType: 'uint256', name: 'matchAmountAfterFees', type: 'uint256' },
      { indexed: false, internalType: 'uint256', name: 'protocolFeeAmount', type: 'uint256' },
      { indexed: false, internalType: 'uint256', name: 'roundFeeAmount', type: 'uint256' },
    ],
  ...
  {
    anonymous: false,
    inputs: [{ indexed: false, internalType: 'address', name: 'roundFeeAddress', type: 'address' }],
    name: 'RoundFeeAddressUpdated',
    type: 'event',
  },
  {
    anonymous: false,
    inputs: [{ indexed: false, internalType: 'uint32', name: 'roundFeePercentage', type: 'uint32' }],
  ...
  },
  {
    inputs: [],
    name: 'alloSettings',
    outputs: [{ internalType: 'contract AlloSettings', name: '', type: 'address' }],
    stateMutability: 'view',
    type: 'function',
  },
  {
  ...
  {
    inputs: [{ internalType: 'uint256', name: 'applicationIndex', type: 'uint256' }],
  ...
  },
  {
    inputs: [],
    name: 'payoutStrategy',
    outputs: [{ internalType: 'contract IPayoutStrategy', name: '', type: 'address' }],
    stateMutability: 'view',
    type: 'function',
  },
  {
  ...
  { inputs: [], name: 'setReadyForPayout', outputs: [], stateMutability: 'payable', type: 'function' },
  {
  ...
  {
    inputs: [{ internalType: 'address payable', name: 'newFeeAddress', type: 'address' }],
  ...
  {
    inputs: [{ internalType: 'uint32', name: 'newFeePercentage', type: 'uint32' }],
  ...
  {
    inputs: [
      { internalType: 'uint256', name: 'newApplicationsStartTime', type: 'uint256' },
      { internalType: 'uint256', name: 'newApplicationsEndTime', type: 'uint256' },
  ...
  {
    inputs: [{ internalType: 'bytes[]', name: 'encodedVotes', type: 'bytes[]' }],
    name: 'vote',
    outputs: [],
  ...
  },
  {
    inputs: [],
    name: 'votingStrategy',
    outputs: [{ internalType: 'contract IVotingStrategy', name: '', type: 'address' }],
    stateMutability: 'view',
    type: 'function',
  },
  {
